        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReminderMinutesBefore = table.Column<bool>(type: "bit", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MissingDevices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MissingDevices_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MissingDevices_Quotes_QuoteId",
                        column: x => x.QuoteId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfitRatio = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    PriceAfterProfit = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    DeviceId = table.Column<int>(type: "int", nullable: false),
                    QuoteId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Quote_Items_Devices_DeviceId",
                        column: x => x.DeviceId,
                        principalTable: "Devices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Devices",
                columns: new[] { "Id", "ButtonCount", "Color", "Name", "Price", "Section", "StockQuantity", "SystemType", "Type" },
                values: new object[,]
                {
                    { 1, null, null, "Panel 1", 50m, "Main", 10, "Lighting", "Panel" },
                    { 2, null, null, "Sensor 1", 15m, "Input", 20, "Lighting", "Sensor" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MissingDevices_DeviceId",
                table: "MissingDevices",
                column: "DeviceId");

            migrationBuilder.CreateIndex(
                name: "IX_MissingDevices_QuoteId",
                table: "MissingDevices",
                column: "QuoteId");
